...
use App\Http\Controllers\Auth\RegisterPetController;
...
use App\Http\Controllers\{
    ...
    AiController, PetSummitController,
};
...
Route::post('register-pet', [RegisterPetController::class, 'register_pet'])->name('register-pet');
...
Route::group(['middleware' => ['auth', 'optimizeImages']], function() {
    ...
    Route::group(['middleware' => 'permission:user access'], function() {
        ...
        Route::post('update-pet/{pet_id}', [HomeController::class, 'update_pet'])->name('update-pet')->middleware('permission:user access');
        Route::get('confirm/{pet_id}', [HomeController::class, 'confirm'])->name('confirm')->middleware('permission:user access');

    });


    // PET SUMMIT ROUTES
    Route::group(['middleware' => 'permission:marketing access'], function() {
        Route::get('pet-summit', [PetSummitController::class, 'index'])->name('pet-summit');

        Route::post('update-pet/{pet_id}', [PetSummitController::class, 'update_pet'])->name('update-pet')->middleware('permission:marketing access');
        Route::get('confirm/{pet_id}', [PetSummitController::class, 'confirm'])->name('confirm')->middleware('permission:marketing access');
