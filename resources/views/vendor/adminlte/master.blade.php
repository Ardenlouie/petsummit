...
<head>
    ...
    @if(config('adminlte.use_ico_only'))
        <link rel="shortcut icon" href="{{ asset('images/cropped.png') }}" />
...
<style>
    body {
        background: linear-gradient(rgba(0, 0, 0, 0), rgba(0, 0, 0, 0)), 
                    url("{{ asset('images/onebg.png') }}") no-repeat center;
            ...
            @default
                ...
                <script>
                    function toggleSubmit() {
                        ...
                        // If checkbox is checked, remove 'disabled', otherwise add it
